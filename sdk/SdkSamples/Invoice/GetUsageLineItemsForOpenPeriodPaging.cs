    ...
    public class GetUsageLineItemsForOpenPeriodPaging : BasePartnerScenario
    {
        ...
        protected override void RunScenario()
        {
            ...
            if (string.IsNullOrWhiteSpace(curencyCode))
            {
                ...
                curencyCode = this.Context.ConsoleHelper.ReadNonEmptyString("Please enter 3 digit currency code to retrieve the unbilled consumptions reconciliation line items ", "The currency code can't be empty");
            }
            else
            {
