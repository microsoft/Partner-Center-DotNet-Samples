...
namespace Microsoft.Store.PartnerCenter.Samples.Invoice
{
    ...
    public class GetUsageLineItemsForOpenPeriodPaging : BasePartnerScenario
    {
        ...
        protected override void RunScenario()
        {
            ...
            Models.SeekBasedResourceCollection<InvoiceLineItem> seekBasedResourceCollection = scopedPartnerOperations.Invoices.ById("unbilled").By("marketplace", "usagelineitems", curencyCode, period, pageMaxSizeReconciliationLineItems).Get();
