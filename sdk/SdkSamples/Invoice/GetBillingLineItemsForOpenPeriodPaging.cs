// -----------------------------------------------------------------------
// <copyright file="GetBillingLineItemsForOpenPeriodPaging.cs" company="Microsoft">
...
namespace Microsoft.Store.PartnerCenter.Samples.Invoice
{
    ...
    /// </summary>
    public class GetBillingLineItemsForOpenPeriodPaging : BasePartnerScenario
    {
        /// <summary>
        ...
        public GetBillingLineItemsForOpenPeriodPaging(IScenarioContext context, int invoicePageSize) : base("Get unbilled reconciliation line items", context)
        {
