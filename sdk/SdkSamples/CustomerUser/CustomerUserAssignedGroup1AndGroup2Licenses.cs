...
namespace Microsoft.Store.PartnerCenter.Samples.CustomerUser
{
    ...
    public class CustomerUserAssignedGroup1AndGroup2Licenses : BasePartnerScenario
    {
        ...
        protected override void RunScenario()
        {
            ...
            Models.ResourceCollection<License> customerUserAssignedGroup1Group2Licenses = partnerOperations.Customers.ById(selectedCustomerId).Users.ById(selectedCustomerUserId).Licenses.Get(groupIds);
