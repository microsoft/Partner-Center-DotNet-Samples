...
namespace Microsoft.Store.PartnerCenter.Samples.Subscriptions
{
    ...
    public class AddSubscriptionAddOn : BasePartnerScenario
    {
        ...
        protected override void RunScenario()
        {
            ...
            string subscriptionId = this.ObtainSubscriptionId(customerId, "Enter the subscription ID for which to purchase an add on");
            ...
            Models.Subscriptions.Subscription parentSubscription = subscriptionOperations.Get();
            ...
            Models.ResourceCollection<Models.Subscriptions.Subscription> subscriptionAddOns = subscriptionOperations.AddOns.Get();
            this.Context.ConsoleHelper.StopProgress();
