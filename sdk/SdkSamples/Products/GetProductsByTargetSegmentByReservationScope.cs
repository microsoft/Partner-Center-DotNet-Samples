// -----------------------------------------------------------------------
// <copyright file="GetProductsByTargetSegmentByReservationScope.cs" company="Microsoft">
...
namespace Microsoft.Store.PartnerCenter.Samples.Products
{
    ...
    /// <summary>
    /// A scenario that retrieves all the products supported in a country, in a catalog view, segment, and reservation scope.
    /// </summary>
    public class GetProductsByTargetSegmentByReservationScope : BasePartnerScenario
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProductsByTargetSegment"/> class.
        /// </summary>
        /// <param name="context">The scenario context.</param>
        public GetProductsByTargetSegmentByReservationScope(IScenarioContext context) : base("Get products by segment and reservation scope", context)
        {
        }
        ...
        protected override void RunScenario()
        {
            ...
            var products = partnerOperations.Products.ByCountry(countryCode).ByTargetView(targetView).ByTargetSegment(segment).ByReservationScope("AzurePlan").Get();
