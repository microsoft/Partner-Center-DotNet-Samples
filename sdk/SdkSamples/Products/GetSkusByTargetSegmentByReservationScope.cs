// -----------------------------------------------------------------------
// <copyright file="GetSkusByTargetSegmentByReservationScope.cs" company="Microsoft">
...
namespace Microsoft.Store.PartnerCenter.Samples.Products
{
    ...
    /// </summary>
    public class GetSkusByTargetSegmentByReservationScope : BasePartnerScenario
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSkusByTargetSegment"/> class.
        /// </summary>
        /// <param name="context">The scenario context.</param>
        public GetSkusByTargetSegmentByReservationScope(IScenarioContext context) : base("Get skus by segment by reservation scope", context)
        {
        }
        ...
        protected override void RunScenario()
        {
            ...
            var skus = partnerOperations.Products.ByCountry(countryCode).ById(productId).Skus.ByTargetSegment(segment).ByReservationScope("AzurePlan").Get();
