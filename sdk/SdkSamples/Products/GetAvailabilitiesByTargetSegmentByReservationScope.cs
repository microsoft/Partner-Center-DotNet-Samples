// -----------------------------------------------------------------------
// <copyright file="GetAvailabilitiesByTargetSegmentByReservationScope.cs" company="Microsoft">
...
namespace Microsoft.Store.PartnerCenter.Samples.Products
{
    ...
    /// <summary>
    /// A scenario that retrieves the availabilities of a product's SKU by segment and reservations scope
    /// </summary>
    public class GetAvailabilitiesByTargetSegmentByReservationScope : BasePartnerScenario
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAvailabilitiesByTargetSegment"/> class.
        /// </summary>
        /// <param name="context">The scenario context.</param>
        public GetAvailabilitiesByTargetSegmentByReservationScope(IScenarioContext context) : base("Get availabilities by segment and reservation scope", context)
        {
        }
        ...
        protected override void RunScenario()
        {
            ...
            var skuAvailabilities = partnerOperations.Products.ByCountry(countryCode).ById(productId).Skus.ById(skuId).Availabilities.ByTargetSegment(segment).ByReservationScope("AzurePlan").Get();
