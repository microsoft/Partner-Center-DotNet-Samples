...
namespace Microsoft.Store.PartnerCenter.Samples.Products
{
    ...
    public class GetAvailabilitiesByTargetSegment : BasePartnerScenario
    {
        ...
        protected override void RunScenario()
        {
            ...
            Models.ResourceCollection<Models.Products.Availability> skuAvailabilities = partnerOperations.Products.ByCountry(countryCode).ById(productId).Skus.ById(skuId).Availabilities.ByTargetSegment(segment).Get();
