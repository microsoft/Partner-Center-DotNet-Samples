// -----------------------------------------------------------------------
// <copyright file="GetProductByReservationScope.cs" company="Microsoft">
...
namespace Microsoft.Store.PartnerCenter.Samples.Products
{
    ...
    /// </summary>
    public class GetProductByReservationScope : BasePartnerScenario
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProduct"/> class.
        /// </summary>
        /// <param name="context">The scenario context.</param>
        public GetProductByReservationScope(IScenarioContext context) : base("Get product by reservation scope", context)
        {
        }
        ...
        protected override void RunScenario()
        {
            ...
            var product = partnerOperations.Products.ByCountry(countryCode).ById(productId).ByReservationScope("AzurePlan").Get();
