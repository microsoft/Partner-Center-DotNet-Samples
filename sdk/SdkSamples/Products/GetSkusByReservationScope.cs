// -----------------------------------------------------------------------
// <copyright file="GetSkusByReservationScope.cs" company="Microsoft">
...
namespace Microsoft.Store.PartnerCenter.Samples.Products
{
    ...
    /// <summary>
    /// A scenario that retrieves all the SKUs related to a product that are supported in a country and for a specific reservation scope.
    /// </summary>
    public class GetSkusByReservationScope : BasePartnerScenario
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSkusByTargetSegment"/> class.
        /// </summary>
        /// <param name="context">The scenario context.</param>
        public GetSkusByReservationScope(IScenarioContext context) : base("Get skus by reservation scope", context)
        {
        }
        ...
        protected override void RunScenario()
        {
            ...
            var skus = partnerOperations.Products.ByCountry(countryCode).ById(productId).Skus.ByReservationScope("AzurePlan").Get();
