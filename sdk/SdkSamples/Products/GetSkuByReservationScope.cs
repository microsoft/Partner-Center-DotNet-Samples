// -----------------------------------------------------------------------
// <copyright file="GetSkuByReservationScope.cs" company="Microsoft">
...
namespace Microsoft.Store.PartnerCenter.Samples.Products
{
    ...
    /// </summary>
    public class GetSkuByReservationScope : BasePartnerScenario
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSku"/> class.
        /// </summary>
        /// <param name="context">The scenario context.</param>
        public GetSkuByReservationScope(IScenarioContext context) : base("Get sku by reservation scope", context)
        {
        }
        ...
        protected override void RunScenario()
        {
            ...
            var sku = partnerOperations.Products.ByCountry(countryCode).ById(productId).Skus.ById(skuId).ByReservationScope("AzurePlan").Get();
