// -----------------------------------------------------------------------
// <copyright file="GetAvailabilitiesByReservationScope.cs" company="Microsoft">
...
namespace Microsoft.Store.PartnerCenter.Samples.Products
{
    ...
    /// <summary>
    /// A scenario that retrieves the availabilities of a product's SKU by reservation scope
    /// </summary>
    public class GetAvailabilitiesByReservationScope : BasePartnerScenario
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAvailabilitiesByTargetSegment"/> class.
        /// </summary>
        /// <param name="context">The scenario context.</param>
        public GetAvailabilitiesByReservationScope(IScenarioContext context) : base("Get availabilities by reservation scope", context)
        {
        }
        ...
        protected override void RunScenario()
        {
            ...
            var skuAvailabilities = partnerOperations.Products.ByCountry(countryCode).ById(productId).Skus.ById(skuId).Availabilities.ByReservationScope("AzurePlan").Get();
