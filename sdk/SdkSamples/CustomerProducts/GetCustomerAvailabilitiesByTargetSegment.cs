...
namespace Microsoft.Store.PartnerCenter.Samples.CustomerProducts
{
    ...
    public class GetCustomerAvailabilitiesByTargetSegment : BasePartnerScenario
    {
        ...
        protected override void RunScenario()
        {
            ...
            Models.ResourceCollection<Models.Products.Availability> skuAvailabilities = partnerOperations.Customers.ById(customerId).Products.ById(productId).Skus.ById(skuId).Availabilities.ByTargetSegment(segment).Get();
