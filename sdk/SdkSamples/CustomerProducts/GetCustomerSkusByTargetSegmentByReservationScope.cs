// -----------------------------------------------------------------------
// <copyright file="GetCustomerSkusByTargetSegmentByReservationScope.cs" company="Microsoft">
...
namespace Microsoft.Store.PartnerCenter.Samples.CustomerProducts
{
    ...
    /// <summary>
    /// A scenario that retrieves all the SKUs related to a product that apply to a customer and that target a specific segment and reservation scope.
    /// </summary>
    public class GetCustomerSkusByTargetSegmentByReservationScope : BasePartnerScenario
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCustomerSkusByTargetSegment"/> class.
        /// </summary>
        /// <param name="context">The scenario context.</param>
        public GetCustomerSkusByTargetSegmentByReservationScope(IScenarioContext context) : base("Get skus for customer by segment and reservation scope", context)
        {
        }
        ...
        protected override void RunScenario()
        {
            ...
            var skus = partnerOperations.Customers.ById(customerId).Products.ById(productId).Skus.ByTargetSegment(segment).ByReservationScope("AzurePlan").Get();
